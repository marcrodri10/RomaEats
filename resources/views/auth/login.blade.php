<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-green-600 shadow-sm focus:ring-green-600 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800"
                    name="remember">
        ...
        <div class="flex justify-center items-center mt-8">
            ...
            <x-primary-button type="submit" value="login" class="ms-3 bg-green-700 pt-3 pb-3 pl-8 pr-8">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
